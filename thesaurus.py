    ...
    <script>
        ...
        function updateGraph(root, isEgg) {
            ...
            setTimeout(() => {
                ...
                nodes = [{ id: root, isCenter: true, isEgg: isEgg }];
                links = [];

                children.forEach(c => {
                    nodes.push({ id: c, isCenter: false, isEgg: isEgg });
        ...
        function render() {
            ...
            const node = svg.append("g")
                ...
                .data(nodes)
                .join("g")
                .attr("class", d => d.isEgg ? "node egg" : "node")
                .on("dblclick", (e, d) => {
                    if (!d.isEgg && db[d.id]) {
            ...
            node.append("circle")
                .attr("r", d => d.isCenter ? 70 : 60)
                .attr("fill", d => d.isCenter ? "#2563eb" : "#0f172a")
                .attr("stroke", "#3b82f6");
